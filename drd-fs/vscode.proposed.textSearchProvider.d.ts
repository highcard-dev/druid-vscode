...
declare module "vscode" {
  ...
  export interface TextSearchQuery {
    ...
    /**
     * Whether or not the search should use regular expressions.
     */
    isRegExp?: boolean;
  }
  ...
  export interface TextSearchPreviewOptions {
     ...
     * Only search providers that support multiline search will ever see `maxLines > 1`.
     */
    maxLines: number;
  ...
  export interface TextSearchComplete {
     ...
     * - If `maxResults` or more matches exist, this should be true.
     * - If less than `maxResults` matches exist, this should be false.
     *
     * The same applies to file search providers.
     */
    limitHit?: boolean;
  }
