...
declare module 'vscode' {
	...
	export interface FileSearchOptions {
		...
		/**
		 * A CancellationToken that represents the session for this search query. If the provider chooses to, this object can be used to check for cancellation and respond accordingly.
		 * When the token is cancelled, the search is expected to stop and not report any further results to the provider.
		 */
